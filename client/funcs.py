...
async def update_db(c):
        ...
        tables = [
            [
                ...
                ["name", "location", "town", "armor", "health", "visited_towns", "donator", "duration", "last"],
                None
            ],
            [
                "players",
                ...
                ["name", "location", "town", "armor", "health", "visited_towns", "donator", "messages", "duration", "last"],
                None
            ],
            [
                "player_history",
                ...
                ["player", "date", "duration", "visited_towns", "likely_town", "likely_nation"],
                None
            ],
            [
                "player_history",
                ...
                ["player", "date", "duration", "visited_towns", "likely_town", "likely_nation", "messages"],
                None
            ],
            [
                "towns",
                ...
                ["name", "nation", "religion", "culture", "mayor", "resident_count", "founded_date", "resident_tax", "bank", "public", "peaceful", "area", "visited_players", "duration", "last_seen"],
                None
            ],
            [
                "town_history",
                ...
                ["town", "date", "nation", "religion", "culture", "mayor", "resident_count", "resident_tax", "bank", "public", "peaceful", "area", "duration", "visited_players", "current_name"],
                None
            ],
            [
                "objects",
                ...
                ["type", "name", "towns", "town_balance", "residents", "area", "duration", "last"],
                None
            ],
            [
                "object_history",
                ...
                ["date", "type", "object", "towns", "town_balance", "residents", "area"],
                None
            ],
            [
                "nation_history",
                ...
                ["nation", "date", "towns", "town_balance", "residents", "capital", "leader", "area", "duration", "current_name"],
                None
            ],
            [
                "global_history",
                ...
                ["date", "towns", "residents", "nations", "town_value", "area", "known_players", "activity"],
                None
            ],
            [
                "global_history",
                ...
                ["date", "towns", "residents", "nations", "town_value", "area", "known_players", "activity", "messages"],
                None
            ],
            [
                "global_day_history",
                ...
                ["time", "towns", "residents", "nations", "town_value", "area", "known_players", "activity"],
                None
            ]
